  ...
  <table class="table table-striped table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td>Cat1, Cat2</td>
        <td class="d-flex">
          <a class="btn btn-outline-success col mx-1" href="?p=lireArticle&article=" role="button">Read<i class="bi bi-file-earmark-text"></i></a>
          <a class="btn btn-primary col mx-1" href="?p=modifierArticle&article=" role="button">update<i class="bi bi-pencil-square"></i></a>
          <a class="btn btn-danger col mx-1" href="?p=supprimerArticle&article=" role="button">delete<i class="bi bi-x-square-fill"></i></a>
        </td>
      </tr>
      <tr>
        <th scope="row">2</th>
