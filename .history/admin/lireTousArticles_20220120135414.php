  ...
  <table class="table table-striped table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td>Cat1, Cat2</td>
        <td class="d-flex">
          <a class="btn btn-outline-success col mx-1" href="lireArticle.html" role="button">Read<i class="bi bi-file-earmark-text"></i></a>
          <a class="btn btn-primary col mx-1" href="modifierArticle.html" role="button">update<i class="bi bi-pencil-square"></i></a>
