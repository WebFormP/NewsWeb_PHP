...
<html lang="fr">
  <head>
    ...
    <title>NewsWeb - Modifier un article</title>
  </head>
  <body>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 col-10">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="#">Créer un article</a></li>
                    <li><a class="dropdown-item active" href="#">Modifier un article</a></li>
